        ...
        <Card title="値上げ状況">
          ...
          <dl className="kv">
            {([
              ...
              [meta?.aggMeta?.m1 || '翌月', d.a_price_m1, d.a_date_m1, d.a_ringi_m1],
              [meta?.aggMeta?.m2 || '翌々月', d.a_price_m2, d.a_date_m2, d.a_ringi_m2],
              [meta?.aggMeta?.m3 || '3か月後', d.a_price_m3, d.a_date_m3, d.a_ringi_m3],
            ] as [string, number | null | undefined, string | null | undefined, string | null | undefined][])
                  ...
                  <dd>
                    ...
                    {(date || ringi) && (
                      <small style={{ color: 'var(--muted)' }}>
                        （{[date && `承認日 ${date}`, ringi && `稟議No ${ringi}`]
                          .filter(Boolean).join(' ・ ')}）
                      </small>
                    )}
                  </dd>
